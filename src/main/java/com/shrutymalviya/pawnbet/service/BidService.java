...
public class BidService {
    ...
    public BidResponseDTO updateBid(BidRequestDTO bidRequestDTO, long bid_id) {
    ...
    public void deleteBid(long bid_id, long bidder_id) {
        Bid bid = bidRepository.findById(bid_id).orElseThrow(() -> new RuntimeException("bid cannot be found"));
        User bidder = userRepository.findById(bidder_id).orElseThrow(()-> new UsernameNotFoundException("User does not exist"));
